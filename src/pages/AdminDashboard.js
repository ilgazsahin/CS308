...
function Dashboard() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optionally re-fetch books to update the table
  ...
  return (
    <div style={styles.dashboardContainer}>
      ...
      <div style={styles.contentContainer}>
        {/* Side navigation or top bar can go here if you like */}
              ...
              {books.map((book) => (
                <tr key={book._id}>
                  ...
                  <td style={styles.tableCell}>
                    {/* You could have Edit/Delete buttons here. */}
                    {/* For now, we just link to detail page if you want */}
